    ...
    async def postrulesloose(self, ctx):
        ...
        embed = discord.Embed(
            ...
            description="> ``1.`` No Spamming.\nThis will result in a kick.\n\n
                ...
                > ``6.`` You are REQUIRED to follow Discord Terms of Service [Discord TOS](https://www.discordapp.com/tos)
                > ``7.`` You are REQUIRED to follow Discord's Community [Guidelines](https://www.discordapp.com/guidelines)",
